...
public enum TelenotMsgType {
    ...
    static {
        ...
        startToMsgType.put("682e2e687302222400000001", TelenotMsgType.MP);
        startToMsgType.put("683e3e687302322400050002", TelenotMsgType.SB);
        // Alarm signal / alarm signal reset ;"682c2c68730205020 0122"
        // Alarm signal / alarm signal reset ;"682c2c68730205020 01a2"
        // startToMsgType.put("683e3e687302322400050002", TelenotMsgType.ALARM);
        // info message "sytem externally armed" ;"682c2c68730205020005320161"
        startToMsgType.put("682c2c68730205020", TelenotMsgType.SYS_EXT_ARMED);
